...
const equalsStyle = { background: "#004466", position: "absolute", height: 130, bottom: 5 };

const Buttons = ({ decimal, evaluate, initialize, numbers, operators }) => {
  return (
    <div>
      <button className="jumbo" id="clear" onClick={initialize} style={clearStyle} value="AC">AC</button>
      <button id="divide" onClick={operators} style={operatorStyle} value="/">/</button>
      <button id="multiply" onClick={operators} style={operatorStyle} value="x">x</button>
      ...
      <button id="subtract" onClick={operators} style={operatorStyle} value="-">-</button>
      ...
      <button id="add" onClick={operators} style={operatorStyle} value="+">+</button>
      ...
      <button id="equals" onClick={evaluate} style={equalsStyle} value="=">=</button>
    </div>
  );
};
